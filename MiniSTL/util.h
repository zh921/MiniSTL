#ifndef MINISTL_UTIL_H_
#define MINISTL_UTIL_H_
...
{
  auto tmp(MiniSTL::move(lhs));
  lhs = MiniSTL::move(rhs);
  rhs = MiniSTL::move(tmp);
}
...
struct pair
{
  ...
  pair& operator=(pair&& rhs)
  {
    if (this != &rhs)
    {
      first = MiniSTL::move(rhs.first);
      second = MiniSTL::move(rhs.second);
    }
    return *this;
  }
...
{
  return pair<Ty1, Ty2>(MiniSTL::forward<Ty1>(first), MiniSTL::forward<Ty2>(second));
}

}

#endif // !MINISTL_UTIL_H_
