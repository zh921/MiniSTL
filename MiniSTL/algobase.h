#ifndef MINISTL_ALGOBASE_H_
#define MINISTL_ALGOBASE_H_

// 这个头文件包含了 MiniSTL 的基本算法
...
BidirectionalIter2 
unchecked_copy_backward_cat(BidirectionalIter1 first, BidirectionalIter1 last,
                            BidirectionalIter2 result, MiniSTL::random_access_iterator_tag)
{
...
MiniSTL::pair<InputIter, OutputIter>
unchecked_copy_n(InputIter first, Size n, OutputIter result, MiniSTL::input_iterator_tag)
{
...
MiniSTL::pair<RandomIter, OutputIter>
unchecked_copy_n(RandomIter first, Size n, OutputIter result, 
                 MiniSTL::random_access_iterator_tag)
{
  auto last = first + n;
  return MiniSTL::pair<RandomIter, OutputIter>(last, MiniSTL::copy(first, last, result));
}
