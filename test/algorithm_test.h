#ifndef MiniSTL_ALGORITHM_TEST_H_
#define MiniSTL_ALGORITHM_TEST_H_

// 算法测试: 包含了 MiniSTL 的 81 个算法测试
...
TEST(copy_test)
{
  ...
  MiniSTL::copy(arr1, arr1 + 5, act);
  EXPECT_CON_EQ(exp, act);
  std::copy(arr1 + 5, arr1 + 10, exp);
  MiniSTL::copy(arr1 + 5, arr1 + 10, act);
  EXPECT_CON_EQ(exp, act);
}
...
TEST(copy_backward_test)
{
  ...
  MiniSTL::copy_backward(arr1, arr1 + 5, act + 5);
  EXPECT_CON_EQ(exp, act);
  std::copy_backward(exp.begin(), exp.begin() + 8, exp.begin() + 9);
  MiniSTL::copy_backward(act, act + 8, act + 9);
  EXPECT_CON_EQ(exp, act);
}
...
TEST(copy_if_test)
{
  ...
  MiniSTL::copy_if(arr1, arr1 + 10, act, is_odd);
  EXPECT_CON_EQ(exp, act);
  std::copy_if(arr1, arr1 + 10, exp, is_even);
  MiniSTL::copy_if(arr1, arr1 + 10, act, is_even);
  EXPECT_CON_EQ(exp, act);
}
...
TEST(copy_n_test)
{
  ...
  MiniSTL::copy_n(arr1, 10, act);
  EXPECT_CON_EQ(exp, act);
  std::copy_n(arr1 + 5, 5, exp);
  MiniSTL::copy_n(arr1 + 5, 5, act);
  EXPECT_CON_EQ(exp, act);
}
...
TEST(move_backward_test)
{
  ...
  MiniSTL::move_backward(arr2, arr2 + 5, act + 5);
  EXPECT_CON_EQ(exp, act);
  EXPECT_CON_EQ(arr1, arr2);
}
...
TEST(equal_test)
{
  ...
  EXPECT_EQ(std::equal(v1.begin(), v1.end(), v2.begin()),
            MiniSTL::equal(v1.begin(), v1.end(), v2.begin()));
  EXPECT_EQ(std::equal(arr1, arr1 + 5, arr2),
            MiniSTL::equal(arr1, arr1 + 5, arr2));
  EXPECT_EQ(std::equal(v1.begin(), v1.end(), arr1),
            MiniSTL::equal(v1.begin(), v1.end(), arr1));
  EXPECT_EQ(std::equal(v1.begin(), v1.end(), arr2, std::equal_to<int>()),
            MiniSTL::equal(v1.begin(), v1.end(), arr2, std::equal_to<int>()));
}

TEST(fill_test)
{
  int exp[10], act[10];
  MiniSTL::vector<int> v1(10, 1);
  MiniSTL::vector<int> v2(10, 2);
  std::fill(exp, exp + 10, 1);
  MiniSTL::fill(act, act + 10, 1);
  EXPECT_CON_EQ(exp, act);
  std::fill(v1.begin(), v1.end(), 3);
  MiniSTL::fill(v2.begin(), v2.end(), 3);
  EXPECT_CON_EQ(v1, v2);
}
...
TEST(fill_n_test)
{
  ...
  int arr2[5];
  std::fill_n(arr2, 5, 1);
  MiniSTL::fill_n(arr1, 5, 1);
  EXPECT_CON_EQ(arr1, arr2);
  std::fill_n(arr1 + 2, 3, 2);
  MiniSTL::fill_n(arr2 + 2, 3, 2);
  EXPECT_CON_EQ(arr1, arr2);
}
...
TEST(lexicographical_compare_test)
{
  ...
  EXPECT_EQ(std::lexicographical_compare(arr1, arr1 + 5, arr2, arr2 + 5),
            MiniSTL::lexicographical_compare(arr1, arr1 + 5, arr2, arr2 + 5));
  EXPECT_EQ(std::lexicographical_compare(arr1, arr1 + 5, arr3, arr3 + 5),
            MiniSTL::lexicographical_compare(arr1, arr1 + 5, arr3, arr3 + 5));
  EXPECT_EQ(std::lexicographical_compare(arr1, arr1 + 5, arr4, arr4 + 6, std::less<int>()),
            MiniSTL::lexicographical_compare(arr1, arr1 + 5, arr4, arr4 + 6, std::less<int>()));
  EXPECT_EQ(std::lexicographical_compare(arr1, arr1 + 5, arr5, arr5 + 3, std::less<int>()),
            MiniSTL::lexicographical_compare(arr1, arr1 + 5, arr5, arr5 + 3, std::less<int>()));
}
...
TEST(max_test)
{
  ...
  char c1 = 'a', c2 = 'b';
  EXPECT_EQ(std::max(i1, i2), MiniSTL::max(i1, i2));
  EXPECT_EQ(std::max(d1, d2), MiniSTL::max(d1, d2));
  EXPECT_EQ(std::max(c1, c2), MiniSTL::max(c1, c2));
}
...
TEST(min_test)
{
  ...
  double d1 = 1.1, d2 = 2.2;
  char c1 = 'a', c2 = 'b';
  EXPECT_EQ(std::min(i1, i2), MiniSTL::min(i1, i2));
  EXPECT_EQ(std::min(d1, d2), MiniSTL::min(d1, d2));
  EXPECT_EQ(std::min(c1, c2), MiniSTL::min(c1, c2));
}
...
TEST(mismatch_test)
{
  ...
  auto p2 = MiniSTL::mismatch(arr1, arr1 + 7, arr2);
  auto p3 = std::mismatch(arr1, arr1 + 7, arr3);
  auto p4 = MiniSTL::mismatch(arr1, arr1 + 7, arr3);
  auto p5 = std::mismatch(arr1, arr1 + 7, arr4, std::equal_to<int>());
  auto p6 = MiniSTL::mismatch(arr1, arr1 + 7, arr4, std::equal_to<int>());
...
TEST(make_heap_test)
{
  ...
  MiniSTL::make_heap(arr2, arr2 + 9);
  std::make_heap(arr3, arr3 + 9);
  MiniSTL::make_heap(arr4, arr4 + 9);
  std::make_heap(arr5, arr5 + 10, std::greater<int>());
  MiniSTL::make_heap(arr6, arr6 + 10, std::greater<int>());
  EXPECT_CON_EQ(arr1, arr2);
...
TEST(pop_heap_test)
{
  ...
  MiniSTL::pop_heap(arr4, arr4 + 9, std::greater<int>());
  EXPECT_CON_EQ(arr3, arr4);
}
...
TEST(push_heap_test)
{
  ...
  MiniSTL::push_heap(arr4, arr4 + 9, std::greater<int>());
  EXPECT_CON_EQ(arr3, arr4);
}
...
TEST(sort_heap_test)
{
  ...
  MiniSTL::sort_heap(arr2, arr2 + 9);
  std::sort_heap(arr3, arr3 + 9, std::greater<int>());
  MiniSTL::sort_heap(arr4, arr4 + 9, std::greater<int>());
  EXPECT_CON_EQ(arr1, arr2);
  EXPECT_CON_EQ(arr3, arr4);
}
...
TEST(set_difference_test)
{
  ...
  MiniSTL::set_difference(arr1, arr1 + 9, arr2, arr2 + 6, act);
  EXPECT_CON_EQ(exp, act);
  std::set_difference(arr2, arr2 + 6, arr3, arr3 + 3, exp);
  MiniSTL::set_difference(arr2, arr2 + 6, arr3, arr3 + 3, act);
  EXPECT_CON_EQ(exp, act);
  std::set_difference(arr1, arr1 + 9, arr3, arr3 + 3, exp, std::less<int>());
  MiniSTL::set_difference(arr1, arr1 + 9, arr3, arr3 + 3, act, std::less<int>());
  EXPECT_CON_EQ(exp, act);
}
...
TEST(set_intersection_test)
{
  ...
  MiniSTL::set_intersection(arr1, arr1 + 9, arr2, arr2 + 6, act);
  EXPECT_CON_EQ(exp, act);
  std::set_intersection(arr2, arr2 + 6, arr3, arr3 + 3, exp);
  MiniSTL::set_intersection(arr2, arr2 + 6, arr3, arr3 + 3, act);
  EXPECT_CON_EQ(exp, act);
  std::set_intersection(arr1, arr1 + 9, arr3, arr3 + 3, exp, std::less<int>());
  MiniSTL::set_intersection(arr1, arr1 + 9, arr3, arr3 + 3, act, std::less<int>());
  EXPECT_CON_EQ(exp, act);
}
...
TEST(set_symmetric_difference_test)
{
  ...
  MiniSTL::set_symmetric_difference(arr1, arr1 + 5, arr2, arr2 + 5, act);
  EXPECT_CON_EQ(exp, act);
  std::set_symmetric_difference(arr1, arr1 + 5, arr3, arr3 + 5, exp);
  MiniSTL::set_symmetric_difference(arr1, arr1 + 5, arr3, arr3 + 5, act);
  EXPECT_CON_EQ(exp, act);
  std::set_symmetric_difference(arr2, arr2 + 5, arr3, arr3 + 5, exp, std::less<int>());
  MiniSTL::set_symmetric_difference(arr2, arr2 + 5, arr3, arr3 + 5, act, std::less<int>());
  EXPECT_CON_EQ(exp, act);
}
...
TEST(set_union_test)
{
  ...
  MiniSTL::set_union(arr1, arr1 + 5, arr2, arr2 + 5, act);
  EXPECT_CON_EQ(exp, act);
  std::set_union(arr1, arr1 + 5, arr3, arr3 + 5, exp);
  MiniSTL::set_union(arr1, arr1 + 5, arr3, arr3 + 5, act);
  EXPECT_CON_EQ(exp, act);
  std::set_union(arr2, arr2 + 5, arr3, arr3 + 5, exp, std::less<int>());
  MiniSTL::set_union(arr2, arr2 + 5, arr3, arr3 + 5, act, std::less<int>());
  EXPECT_CON_EQ(exp, act);
}
...
TEST(accumulate_test)
{
  ...
  EXPECT_EQ(std::accumulate(arr1, arr1 + 5, 0),
            MiniSTL::accumulate(arr1, arr1 + 5, 0));
  EXPECT_EQ(std::accumulate(arr1, arr1 + 5, 5),
            MiniSTL::accumulate(arr1, arr1 + 5, 5));
  EXPECT_EQ(std::accumulate(arr1, arr1 + 5, 0, std::minus<int>()),
            MiniSTL::accumulate(arr1, arr1 + 5, 0, std::minus<int>()));
}
...
TEST(adjacent_difference_test)
{
  ...
  MiniSTL::adjacent_difference(arr1, arr1 + 5, act);
  EXPECT_CON_EQ(exp, act);
  std::adjacent_difference(arr2, arr2 + 5, exp, std::minus<int>());
  MiniSTL::adjacent_difference(arr2, arr2 + 5, act, std::minus<int>());
  EXPECT_CON_EQ(exp, act);
}
...
TEST(inner_product_test)
{
  ...
  EXPECT_EQ(std::inner_product(arr1, arr1 + 5, arr3, 0),
            MiniSTL::inner_product(arr1, arr1 + 5, arr3, 0));
  EXPECT_EQ(std::inner_product(arr2, arr2 + 5, arr3, 0, std::minus<int>(), std::multiplies<int>()),
            MiniSTL::inner_product(arr2, arr2 + 5, arr3, 0, std::minus<int>(), std::multiplies<int>()));
}
...
TEST(adjacent_find_test)
{
  ...
  EXPECT_EQ(std::adjacent_find(arr1, arr1 + 5),
            MiniSTL::adjacent_find(arr1, arr1 + 5));
  EXPECT_EQ(std::adjacent_find(arr2, arr2 + 5),
            MiniSTL::adjacent_find(arr2, arr2 + 5));
  EXPECT_EQ(std::adjacent_find(arr1, arr1 + 5, std::greater<int>()),
            MiniSTL::adjacent_find(arr1, arr1 + 5, std::greater<int>()));
}
...
TEST(all_of_test)
{
  ...
  EXPECT_EQ(std::all_of(arr1, arr1 + 5, is_odd),
            MiniSTL::all_of(arr1, arr1 + 5, is_odd));
  EXPECT_EQ(std::all_of(arr2, arr2 + 5, is_odd),
            MiniSTL::all_of(arr2, arr2 + 5, is_odd));
}
...
TEST(any_of_test)
{
  ...
  EXPECT_EQ(std::any_of(arr1, arr1 + 5, is_odd),
            MiniSTL::any_of(arr1, arr1 + 5, is_odd));
  EXPECT_EQ(std::any_of(arr2, arr2 + 5, is_odd),
            MiniSTL::any_of(arr2, arr2 + 5, is_odd));
}
...
TEST(binary_search_test)
{
  ...
  EXPECT_EQ(std::binary_search(arr1, arr1 + 5, 1),
            MiniSTL::binary_search(arr1, arr1 + 5, 1));
  EXPECT_EQ(std::binary_search(arr1, arr1 + 5, 6),
            MiniSTL::binary_search(arr1, arr1 + 5, 6));
}
...
TEST(count_test)
{
  ...
  EXPECT_EQ(std::count(arr1, arr1 + 9, 2),
            MiniSTL::count(arr1, arr1 + 9, 2));
  EXPECT_EQ(std::count(arr1, arr1 + 9, 3),
            MiniSTL::count(arr1, arr1 + 9, 3));
  EXPECT_EQ(std::count(arr1, arr1 + 9, 6),
            MiniSTL::count(arr1, arr1 + 9, 6));
}
...
TEST(count_if_test)
{
  ...
  EXPECT_EQ(std::count_if(arr1, arr1 + 9, is_odd),
            MiniSTL::count_if(arr1, arr1 + 9, is_odd));
  EXPECT_EQ(std::count_if(arr1, arr1 + 9, is_even),
            MiniSTL::count_if(arr1, arr1 + 9, is_even));
}

TEST(equal_range_test)
{
  int arr1[] = { 1,2,3,3,3,4,5 };
  auto p1 = MiniSTL::equal_range(arr1, arr1 + 7, 3);
  auto p2 = std::equal_range(arr1, arr1 + 7, 3);
  auto p3 = MiniSTL::equal_range(arr1, arr1 + 7, 6, std::equal_to<int>());
...
{
  int arr1[] = { 1,2,3,4,5 };
  EXPECT_EQ(std::find(arr1, arr1 + 5, 3), MiniSTL::find(arr1, arr1 + 5, 3));
  EXPECT_EQ(std::find(arr1, arr1 + 5, 6), MiniSTL::find(arr1, arr1 + 5, 6));
}
...
TEST(find_end_test)
{
  ...
  EXPECT_EQ(std::find_end(arr1, arr1 + 8, arr2, arr2 + 1),
            MiniSTL::find_end(arr1, arr1 + 8, arr2, arr2 + 1));
  EXPECT_EQ(std::find_end(arr1, arr1 + 8, arr3, arr3 + 2),
            MiniSTL::find_end(arr1, arr1 + 8, arr3, arr3 + 2));
  EXPECT_EQ(std::find_end(arr1, arr1 + 8, arr3, arr3 + 2),
            MiniSTL::find_end(arr1, arr1 + 8, arr3, arr3 + 2));
  EXPECT_EQ(std::find_end(arr1, arr1 + 8, arr3, arr3, std::less<int>()),
            MiniSTL::find_end(arr1, arr1 + 8, arr3, arr3, std::less<int>()));
}
...
TEST(find_first_of_test)
{
  ...
  EXPECT_EQ(std::find_first_of(arr1, arr1 + 5, arr2, arr2 + 3),
            MiniSTL::find_first_of(arr1, arr1 + 5, arr2, arr2 + 3));
  EXPECT_EQ(std::find_first_of(arr1, arr1 + 5, arr3, arr3 + 3, std::equal_to<int>()),
            MiniSTL::find_first_of(arr1, arr1 + 5, arr3, arr3 + 3, std::equal_to<int>()));
}
...
TEST(find_if_test)
{
  ...
  EXPECT_EQ(std::find_if(arr1, arr1 + 5, is_odd),
            MiniSTL::find_if(arr1, arr1 + 5, is_odd));
  EXPECT_EQ(std::find_if(arr1, arr1 + 5, is_even),
            MiniSTL::find_if(arr1, arr1 + 5, is_even));
}
...
TEST(find_if_not_test)
{
  ...
  EXPECT_EQ(std::find_if_not(arr1, arr1 + 5, is_odd),
            MiniSTL::find_if_not(arr1, arr1 + 5, is_odd));
  EXPECT_EQ(std::find_if_not(arr1, arr1 + 5, is_even),
            MiniSTL::find_if_not(arr1, arr1 + 5, is_even));
}
...
TEST(for_each_test)
{
  ...
  MiniSTL::for_each(v1.begin(), v1.end(), arr_sum);
...
TEST(generate_test)
{
  ...
  MiniSTL::generate(arr2, arr2 + 5, gen);
  EXPECT_CON_EQ(arr1, arr2);
}
...
TEST(includes_test)
{
  ...
  EXPECT_EQ(std::includes(v1.begin(), v1.end(), v2.begin(), v2.end()),
            MiniSTL::includes(v1.begin(), v1.end(), v2.begin(), v2.end()));
  EXPECT_EQ(std::includes(v1.begin(), v1.end(), v3.begin(), v3.end()),
            MiniSTL::includes(v1.begin(), v1.end(), v3.begin(), v3.end()));
  EXPECT_EQ(std::includes(v1.begin(), v1.end(), v4.begin(), v4.end()),
            MiniSTL::includes(v1.begin(), v1.end(), v4.begin(), v4.end()));
  EXPECT_EQ(std::includes(v1.begin(), v1.end(), v5.begin(), v5.end(), std::less<int>()),
            MiniSTL::includes(v1.begin(), v1.end(), v5.begin(), v5.end(), std::less<int>()));
}
...
TEST(inplace_merge_test)
{
  ...
  MiniSTL::inplace_merge(arr2, arr2 + 5, arr2 + 10);
  std::inplace_merge(arr3, arr3 + 3, arr3 + 8, std::less<int>());
  MiniSTL::inplace_merge(arr4, arr4 + 3, arr4 + 8, std::less<int>());
  EXPECT_CON_EQ(arr1, arr2);
  EXPECT_CON_EQ(arr3, arr4);
}
...
TEST(is_heap_test)
{
  ...
  EXPECT_EQ(std::is_heap(arr1, arr1 + 10), MiniSTL::is_heap(arr1, arr1 + 10));
  EXPECT_EQ(std::is_heap(arr2, arr2 + 10, std::less<int>()),
            MiniSTL::is_heap(arr2, arr2 + 10, std::less<int>()));
  EXPECT_EQ(std::is_heap(arr3, arr3 + 10), MiniSTL::is_heap(arr3, arr3 + 10));
  EXPECT_EQ(std::is_heap(arr4, arr4 + 10), MiniSTL::is_heap(arr4, arr4 + 10));
}
...
TEST(is_sorted_test)
{
  ...
  int arr3[] = { 5,4,3,2,1 };
  int arr4[] = { 1,2,5,4,3 };
  EXPECT_EQ(std::is_sorted(arr1, arr1 + 5), MiniSTL::is_sorted(arr1, arr1 + 5));
  EXPECT_EQ(std::is_sorted(arr2, arr2 + 5), MiniSTL::is_sorted(arr2, arr2 + 5));
  EXPECT_EQ(std::is_sorted(arr3, arr3 + 5, std::less<int>()),
            MiniSTL::is_sorted(arr3, arr3 + 5, std::less<int>()));
  EXPECT_EQ(std::is_sorted(arr4, arr4 + 5, std::less<int>()),
            MiniSTL::is_sorted(arr4, arr4 + 5, std::less<int>()));
}
...
TEST(lower_bound_test)
{
  ...
  EXPECT_EQ(std::lower_bound(arr1, arr1 + 7, 1),
            MiniSTL::lower_bound(arr1, arr1 + 7, 1));
  EXPECT_EQ(std::lower_bound(arr1, arr1 + 7, 2),
            MiniSTL::lower_bound(arr1, arr1 + 7, 2));
  EXPECT_EQ(std::lower_bound(arr1, arr1 + 7, 3),
            MiniSTL::lower_bound(arr1, arr1 + 7, 3));
  EXPECT_EQ(std::lower_bound(arr1, arr1 + 7, 5, std::less<int>()),
            MiniSTL::lower_bound(arr1, arr1 + 7, 5, std::less<int>()));
}
...
TEST(max_elememt_test)
{
  ...
  EXPECT_PTR_EQ(std::max_element(arr1, arr1 + 9),
                MiniSTL::max_element(arr1, arr1 + 9));
  EXPECT_PTR_EQ(std::max_element(arr2, arr2 + 6, std::less<double>()),
                MiniSTL::max_element(arr2, arr2 + 6, std::less<double>()));
}
...
TEST(median_test)
{
  ...
  EXPECT_EQ(2, MiniSTL::median(ia, ib, ic));
  EXPECT_EQ(3.1, MiniSTL::median(da, db, dc, std::greater<double>()));
}
...
TEST(merge_test)
{
  ...
  MiniSTL::merge(arr3, arr3 + 5, arr4, arr4 + 5, act);
  EXPECT_CON_EQ(exp, act);
  std::merge(arr1, arr1 + 5, arr2, arr2 + 5, exp, std::less<int>());
  MiniSTL::merge(arr3, arr3 + 5, arr4, arr4 + 5, act, std::less<int>());
  EXPECT_CON_EQ(exp, act);
}
...
TEST(is_permutation_test)
{
  ...
  EXPECT_EQ(std::is_permutation(arr1, arr1 + 5, arr2),
            MiniSTL::is_permutation(arr1, arr1 + 5, arr2, arr2 + 5));
  EXPECT_EQ(std::is_permutation(arr1, arr1 + 5, arr3),
            MiniSTL::is_permutation(arr1, arr1 + 5, arr3, arr3 + 5));
  EXPECT_EQ(std::is_permutation(arr1, arr1 + 5, arr2, std::equal_to<int>()),
            MiniSTL::is_permutation(arr1, arr1 + 5, arr2, arr2 + 5, std::equal_to<int>()));
  EXPECT_EQ(std::is_permutation(arr1, arr1 + 5, arr3, std::equal_to<int>()),
            MiniSTL::is_permutation(arr1, arr1 + 5, arr3, arr3 + 5, std::equal_to<int>()));
}
...
TEST(next_permutation_test)
{
  ...
  while (MiniSTL::next_permutation(arr1, arr1 + 4))    n2++;
  EXPECT_EQ(n1, n2);
  for (; n1 > 0; n1--)
  {
    std::next_permutation(arr1, arr1 + 4);
    MiniSTL::next_permutation(arr2, arr2 + 4);
    EXPECT_CON_EQ(arr1, arr2);
  }
  std::next_permutation(arr1, arr1 + 4, std::greater<int>());
  MiniSTL::next_permutation(arr2, arr2 + 4, std::greater<int>());
  EXPECT_CON_EQ(arr1, arr2);
}
...
TEST(none_of_test)
{
  ...
  EXPECT_EQ(std::none_of(arr1, arr1 + 5, is_even),
            MiniSTL::none_of(arr1, arr1 + 5, is_even));
  EXPECT_EQ(std::none_of(arr2, arr2 + 5, is_even),
            MiniSTL::none_of(arr2, arr2 + 5, is_even));
  EXPECT_EQ(std::none_of(arr3, arr3 + 5, is_even),
            MiniSTL::none_of(arr3, arr3 + 5, is_even));
}
...
TEST(nth_element_test)
{
  ...
  MiniSTL::nth_element(arr1, arr1 + 4, arr1 + 9);
  MiniSTL::nth_element(arr2, arr2 + 2, arr2 + 9);
  MiniSTL::nth_element(arr3, arr3 + 8, arr3 + 9, std::less<int>());
  MiniSTL::nth_element(arr4, arr4 + 3, arr4 + 16, std::less<int>());
...
TEST(partial_sort_test)
{
  ...
  MiniSTL::partial_sort(arr2, arr2 + 2, arr2 + 9);
  std::partial_sort(arr3, arr3 + 5, arr3 + 13, std::greater<int>());
  MiniSTL::partial_sort(arr4, arr4 + 5, arr4 + 13, std::greater<int>());
  EXPECT_CON_EQ(arr1, arr2);
  EXPECT_CON_EQ(arr3, arr4);
}
...
TEST(partial_sort_copy_test)
{
  ...
  MiniSTL::partial_sort_copy(arr1, arr1 + 9, act, act + 5);
  EXPECT_CON_EQ(exp, act);
  std::partial_sort_copy(arr2, arr2 + 9, exp, exp + 5);
  MiniSTL::partial_sort_copy(arr2, arr2 + 9, act, act + 5);
  EXPECT_CON_EQ(exp, act);
  std::partial_sort_copy(arr3, arr3 + 15, exp, exp + 5, std::greater<int>());
  MiniSTL::partial_sort_copy(arr3, arr3 + 15, act, act + 5, std::greater<int>());
  EXPECT_CON_EQ(exp, act);
}
...
TEST(partition_test)
{
  ...
  MiniSTL::partition(arr2, arr2 + 9, is_odd);
  EXPECT_CON_EQ(arr1, arr2);
  std::partition(arr1, arr1 + 9, is_even);
  MiniSTL::partition(arr2, arr2 + 9, is_even);
  EXPECT_CON_EQ(arr1, arr2);
}
...
TEST(partition_copy_test)
{
  ...
  MiniSTL::partition_copy(arr1, arr1 + 10, act_true, act_false, is_odd);
...
TEST(prev_permutation_test)
{
  ...
  while (MiniSTL::prev_permutation(arr1, arr1 + 4))    n2++;
  EXPECT_EQ(n1, n2);
  for (; n1 > 0; n1--)
  {
    std::prev_permutation(arr1, arr1 + 4);
    MiniSTL::prev_permutation(arr2, arr2 + 4);
    EXPECT_CON_EQ(arr1, arr2);
  }
  std::prev_permutation(arr1, arr1 + 4, std::greater<int>());
  MiniSTL::prev_permutation(arr2, arr2 + 4, std::greater<int>());
  EXPECT_CON_EQ(arr1, arr2);
}
...
TEST(random_shuffle_test)
{
  ...
  for (int i = 0; i < 9; ++i)
  {
    ...
    MiniSTL::random_shuffle(arr1, arr1 + 9);
    EXPECT_CON_NE(arr1, arr2);
  }
  std::copy(arr1, arr1 + 9, arr2);
  MiniSTL::random_shuffle(arr1, arr1 + 9, r);
  EXPECT_CON_NE(arr1, arr2);
}
...
TEST(remove_test)
{
  ...
  MiniSTL::remove(v2.begin(), v2.end(), 3);
  EXPECT_CON_EQ(v1, v2);
  std::remove(v1.begin(), v1.end(), 6);
  MiniSTL::remove(v2.begin(), v2.end(), 6);
  EXPECT_CON_EQ(v1, v2);
}
...
TEST(remove_copy_test)
{
  ...
  MiniSTL::remove_copy(arr2, arr2 + 8, act, 6);
  EXPECT_CON_EQ(exp, act);
  std::remove_copy(arr1, arr1 + 5, exp, 3);
  MiniSTL::remove_copy(arr2, arr2 + 5, act, 3);
  EXPECT_CON_EQ(exp, act);
}
...
TEST(remove_copy_if_test)
{
  ...
  MiniSTL::remove_copy_if(arr1, arr1 + 10, act, is_odd);
  EXPECT_CON_EQ(exp, act);
  std::remove_copy_if(arr1, arr1 + 10, exp, is_even);
  MiniSTL::remove_copy_if(arr1, arr1 + 10, act, is_even);
  EXPECT_CON_EQ(exp, act);
}
...
TEST(remove_if_test)
{
  ...
  MiniSTL::remove_if(v2.begin(), v2.end(), is_odd);
  EXPECT_CON_EQ(v1, v2);
}
...
TEST(replace_test)
{
  ...
  MiniSTL::replace(arr2, arr2 + 9, 1, 4);
  EXPECT_CON_EQ(arr1, arr2);
  std::replace(arr1, arr1 + 9, 2, 5);
  MiniSTL::replace(arr2, arr2 + 9, 2, 5);
  EXPECT_CON_EQ(arr1, arr2);
  std::replace(arr1, arr1 + 9, 3, 6);
  MiniSTL::replace(arr2, arr2 + 9, 3, 6);
  EXPECT_CON_EQ(arr1, arr2);
}
...
TEST(replace_copy_test)
{
  ...
  MiniSTL::replace_copy(arr1, arr1 + 9, act, 1, 4);
  EXPECT_CON_EQ(exp, act);
  std::replace_copy(arr1, arr1 + 9, exp, 2, 5);
  MiniSTL::replace_copy(arr1, arr1 + 9, act, 2, 5);
  EXPECT_CON_EQ(exp, act);
  std::replace_copy(arr1, arr1 + 9, exp, 3, 6);
  MiniSTL::replace_copy(arr1, arr1 + 9, act, 3, 6);
  EXPECT_CON_EQ(exp, act);
}
...
TEST(replace_copy_if_test)
{
  ...
  MiniSTL::replace_copy_if(arr1, arr1 + 10, act, is_odd, 1);
  EXPECT_CON_EQ(exp, act);
  std::replace_copy_if(arr1, arr1 + 10, exp, is_even, 2);
  MiniSTL::replace_copy_if(arr1, arr1 + 10, act, is_even, 2);
  EXPECT_CON_EQ(exp, act);
}
...
TEST(replace_if_test)
{
  ...
  MiniSTL::replace_if(v2.begin(), v2.end(), is_odd, 1);
  EXPECT_CON_EQ(v1, v2);
  std::replace_if(v1.begin(), v1.end(), is_even, 2);
  MiniSTL::replace_if(v2.begin(), v2.end(), is_even, 2);
  EXPECT_CON_EQ(v1, v2);
}
...
TEST(reverse_test)
{
  ...
  MiniSTL::reverse(arr2, arr2 + 9);
  EXPECT_CON_EQ(arr1, arr2);
  std::reverse(arr1, arr1 + 5);
  MiniSTL::reverse(arr2, arr2 + 5);
  EXPECT_CON_EQ(arr1, arr2);
}
...
TEST(reverse_copy_test)
{
  ...
  MiniSTL::reverse_copy(arr1, arr1 + 5, act);
  EXPECT_CON_EQ(exp, act);
  std::reverse_copy(arr1 + 4, arr1 + 9, exp);
  MiniSTL::reverse_copy(arr1 + 4, arr1 + 9, act);
  EXPECT_CON_EQ(exp, act);
}
...
TEST(rotate_test)
{
  ...
  MiniSTL::rotate(arr2, arr2 + 3, arr2 + 9);
  EXPECT_CON_EQ(arr1, arr2);
  std::rotate(arr1 + 3, arr1 + 5, arr1 + 9);
  MiniSTL::rotate(arr2 + 3, arr2 + 5, arr2 + 9);
  EXPECT_CON_EQ(arr1, arr2);
  std::rotate(arr1, arr1 + 9, arr1 + 9);
  MiniSTL::rotate(arr2, arr2 + 9, arr2 + 9);
  EXPECT_CON_EQ(arr1, arr2);
}
...
TEST(rotate_copy_test)
{
  ...
  MiniSTL::rotate_copy(arr1, arr1 + 5, arr1 + 9, act);
  EXPECT_CON_EQ(exp, act);
  std::rotate_copy(arr1, arr1, arr1 + 9, exp);
  MiniSTL::rotate_copy(arr1, arr1, arr1 + 9, act);
  EXPECT_CON_EQ(exp, act);
  std::rotate_copy(arr1, arr1 + 9, arr1 + 9, exp);
  MiniSTL::rotate_copy(arr1, arr1 + 9, arr1 + 9, act);
  EXPECT_CON_EQ(exp, act);
}
...
TEST(search_test)
{
  ...
  EXPECT_EQ(std::search(arr1, arr1 + 9, arr2, arr2 + 1),
            MiniSTL::search(arr1, arr1 + 9, arr2, arr2 + 1));
  EXPECT_EQ(std::search(arr1, arr1 + 9, arr3, arr3 + 2),
            MiniSTL::search(arr1, arr1 + 9, arr3, arr3 + 2));
  EXPECT_EQ(std::search(arr1, arr1 + 9, arr4, arr4 + 3, std::less<int>()),
            MiniSTL::search(arr1, arr1 + 9, arr4, arr4 + 3, std::less<int>()));
  EXPECT_EQ(std::search(arr1, arr1 + 9, arr4, arr4 + 4, std::less<int>()),
            MiniSTL::search(arr1, arr1 + 9, arr4, arr4 + 4, std::less<int>()));
}
...
TEST(search_n_test)
{
  ...
  EXPECT_EQ(std::search_n(arr1, arr1 + 9, 1, 0),
            MiniSTL::search_n(arr1, arr1 + 9, 1, 0));
  EXPECT_EQ(std::search_n(arr1, arr1 + 9, 2, 2),
            MiniSTL::search_n(arr1, arr1 + 9, 2, 2));
  EXPECT_EQ(std::search_n(arr1, arr1 + 9, 1, 3),
            MiniSTL::search_n(arr1, arr1 + 9, 1, 3));
  EXPECT_EQ(std::search_n(arr1, arr1 + 9, 3, 6, std::less<int>()),
            MiniSTL::search_n(arr1, arr1 + 9, 3, 6, std::less<int>()));
  EXPECT_EQ(std::search_n(arr1, arr1 + 9, 2, 10, std::less<int>()),
            MiniSTL::search_n(arr1, arr1 + 9, 2, 10, std::less<int>()));
}
...
TEST(sort_test)
{
  ...
  MiniSTL::sort(arr2, arr2 + 14);
  std::sort(arr3, arr3 + 20);
  MiniSTL::sort(arr4, arr4 + 20);
  std::sort(arr5, arr5 + 9, std::greater<int>());
  MiniSTL::sort(arr6, arr6 + 9, std::greater<int>());
  EXPECT_CON_EQ(arr1, arr2);
  EXPECT_CON_EQ(arr3, arr4);
  EXPECT_CON_EQ(arr5, arr6);
}
...
TEST(swap_ranges_test)
{
  ...
  MiniSTL::swap_ranges(arr2, arr2 + 6, arr4);
  std::swap_ranges(arr1, arr1 + 3, arr5);
  MiniSTL::swap_ranges(arr2, arr2 + 3, arr6);
  EXPECT_CON_EQ(arr1, arr2);
  EXPECT_CON_EQ(arr1, arr2);
}
...
TEST(transform_test)
{
  ...
  MiniSTL::transform(arr1, arr1 + 9, act, unary_op);
  EXPECT_CON_EQ(exp, act);
  std::transform(arr1, arr1 + 9, arr2, exp, binary_op);
  MiniSTL::transform(arr1, arr1 + 9, arr2, act, binary_op);
  EXPECT_CON_EQ(exp, act);
}
...
TEST(unique_copy_test)
{
  ...
  MiniSTL::unique_copy(arr1, arr1 + 10, act);
  EXPECT_CON_EQ(exp, act);
  std::unique_copy(arr2, arr2 + 9, exp, std::equal_to<int>());
  MiniSTL::unique_copy(arr2, arr2 + 9, act, std::equal_to<int>());
  EXPECT_CON_EQ(exp, act);
}
...
TEST(upper_bound_test)
{
  ...
  EXPECT_EQ(std::upper_bound(arr1, arr1 + 9, 0),
            MiniSTL::upper_bound(arr1, arr1 + 9, 0));
  EXPECT_EQ(std::upper_bound(arr1, arr1 + 9, 1),
            MiniSTL::upper_bound(arr1, arr1 + 9, 1));
  EXPECT_EQ(std::upper_bound(arr1, arr1 + 9, 3),
            MiniSTL::upper_bound(arr1, arr1 + 9, 3));
  EXPECT_EQ(std::upper_bound(arr1, arr1 + 9, 6, std::less<int>()),
            MiniSTL::upper_bound(arr1, arr1 + 9, 6, std::less<int>()));
  EXPECT_EQ(std::upper_bound(arr1, arr1 + 9, 7, std::less<int>()),
            MiniSTL::upper_bound(arr1, arr1 + 9, 7, std::less<int>()));
}
...
#endif // !MiniSTL_ALGORITHM_TEST_H_
