#ifndef MINISTL_UNINITIALIZED_H_
#define MINISTL_UNINITIALIZED_H_
...
{
  return MiniSTL::unchecked_uninit_copy(first, last, result, 
...
{
  return MiniSTL::unchecked_uninit_copy_n(first, n, result,
                                        std::is_trivially_copy_assignable<
...
{
  MiniSTL::unchecked_uninit_fill(first, last, value, 
                               std::is_trivially_copy_assignable<
                               typename iterator_traits<ForwardIter>::
                               value_type>{});
}
...
{
  return MiniSTL::unchecked_uninit_fill_n(first, n, value, 
                                        std::is_trivially_copy_assignable<
                                        typename iterator_traits<ForwardIter>::
                                        value_type>{});
}
...
{
  return MiniSTL::unchecked_uninit_move_n(first, n, result,
                                        std::is_trivially_move_assignable<
                                        typename iterator_traits<InputIter>::
                                        value_type>{});
}
...
#endif // !MINISTL_UNINITIALIZED_H_
